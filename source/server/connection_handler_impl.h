...
public:
  ...
  // TODO(lambdai): Extract common interface for ActiveTcpSocket and ActiveInternalSocket.
  ...
  /////////////////////////////////////////////////////////////
  class ActiveInternalListener : public ActiveListenerImplBase,
                                 public Network::InternalListenerCallbacks {
  public:
    ActiveInternalListener(Network::ConnectionHandler& conn_handler,
    ...
    getOrCreateActiveConnections(const Network::FilterChain& filter_chain);
