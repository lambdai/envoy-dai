...
class ConnPoolImpl : Logger::Loggable<Logger::Id::pool>, public Tcp::ConnectionPool::Instance {
public:
  ...
  newConnection(Tcp::ConnectionPool::Callbacks& callbacks) override;
...
protected:
  ...
  struct ConnectionWrapper {
    ...
    void addUpstreamCallbacks(Tcp::ConnectionPool::UpstreamCallbacks& callbacks);
    void setConnectionState(Tcp::ConnectionPool::ConnectionStatePtr&& state) {
      parent_.setConnectionState(std::move(state));
    };
    Tcp::ConnectionPool::ConnectionState* connectionState() { return parent_.connectionState(); }
  ...
  struct ConnectionDataImpl : public Tcp::ConnectionPool::ConnectionData {
  ...
  struct ActiveConn : LinkedObject<ActiveConn>,
    ...
    Tcp::ConnectionPool::ConnectionState* connectionState() { return conn_state_.get(); }
  ...
  struct PendingRequest : LinkedObject<PendingRequest>, public Tcp::ConnectionPool::Cancellable {
    PendingRequest(ConnPoolImpl& parent, Tcp::ConnectionPool::Callbacks& callbacks);
    ~PendingRequest() override;

    // Tcp::ConnectionPool::Cancellable
    void cancel(Tcp::ConnectionPool::CancelPolicy cancel_policy) override {
  ...
  void assignConnection(ActiveConn& conn, Tcp::ConnectionPool::Callbacks& callbacks);
